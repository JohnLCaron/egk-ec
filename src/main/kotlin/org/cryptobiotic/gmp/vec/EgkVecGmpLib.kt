...
./jextract  --source \
    --header-class-name EgkVecGmpIF \
    --target-package org.cryptobiotic.gmp.vec \
    -I /home/stormy/dev/github/verificatum/verificatum-vec/vec.h \
    -l /usr/local/lib/libvec.so \
