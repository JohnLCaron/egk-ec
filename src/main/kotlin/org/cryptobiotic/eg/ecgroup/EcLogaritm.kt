...
class EcLogaritm(val group: VecGroup) {
    val base = group.g

    private val dLogMapping: MutableMap<VecElementModP, Int> =
        ConcurrentHashMap<VecElementModP, Int>()
            .apply {
                this[group.ONE] = 0
            }
    ...
    fun dLog(input: VecElementModP, maxResult: Int): Int? =
