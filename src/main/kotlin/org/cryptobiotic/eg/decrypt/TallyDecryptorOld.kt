...
internal class TallyDecryptorOld(
    ...
    private fun decryptContest(
        ...
        val selections = contest.selections.map {
            val id = contestSelectionKey(contest.contestId, it.selectionId)
    ...
    private fun decryptSelection(
        ...
        stats.of("verifySelection", "selection", "selections").accum(stopwatch.stop(), 1)
