...
class GroupTest {
   ...
   // fun additionWrappingQSm() = additionWrappingQ { tinyGroup() }
    ...
    //@Test fun multiplicationBasicsQsm() = multiplicationBasicsQ { tinyGroup() }
    ...
    // @Test fun subtractionBasicsSm() = subtractionBasics { tinyGroup() }
    ...
    // @Test fun negationSm() = negation { tinyGroup() }
    ...
    // @Test fun multiplicativeInversesPSm() = multiplicativeInversesP { tinyGroup() }
    ...
    // @Test fun multiplicativeInversesQSm() = multiplicativeInversesQ { tinyGroup() }
    ...
    // @Test fun divisionPSm() = divisionP { tinyGroup() }
    ...
    // @Test fun exponentiationSm() = exponentiation { tinyGroup() }
    ...
    // @Test fun subgroupInversesSm() = subgroupInverses { tinyGroup() }
    ...
    // @Test fun iterableAdditionSm() = iterableAddition { tinyGroup() }
    ...
    // @Test fun iterableMultiplicationSm() = iterableMultiplication { tinyGroup() }
